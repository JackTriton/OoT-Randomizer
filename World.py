...
class World:
    ...
    def create_dungeons(self) -> list[tuple[Entrance, str]]:
        savewarps_to_connect = []
        for hint_area_name in self.language.hint_area_enum.keys():
            if (name := self.HintAreaLang[hint_area_name].dungeon_name) is not None:
                ...
                self.dungeons.append(Dungeon(self, name, hint_area_name))
        return savewarps_to_connect
    ...
    def set_empty_dungeon_rewards(self, empty_rewards: list[str] = []) -> None:
        ...
        for boss in empty_dungeon_bosses:
            hint_area = self.HintAreaLang.at(boss)
    ...
    def region_has_shortcuts(self, region_name: str) -> bool:
        ...
        dungeon_name = self.HintAreaLang.at(region).dungeon_name
    ...
    def update_useless_areas(self, spoiler: Spoiler) -> None:
        ...
        excluded_areas = [None, self.HintAreaLang.ROOT]
        for location in self.get_locations():
            location_hint = self.HintAreaLang.at(location)
