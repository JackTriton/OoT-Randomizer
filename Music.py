...
def rebuild_sequences(rom: Rom, sequences: list[Sequence], log: CosmeticsLog, symbols: dict[str, int]) -> None:
    ...
    bank_index_base = rom.payload_vram_to_rom(rom.read_int32(symbols['CFG_AUDIOBANK_TABLE_EXTENDED_ADDR']))
    ...
    for i in range(0x6E):
        bank_table_base = rom.payload_vram_to_rom(rom.read_int32(symbols['CFG_AUDIOBANK_TABLE_EXTENDED_ADDR']))
