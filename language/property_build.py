...
ITEM_MESSAGES: list[tuple[int, str]] = [
    (0x0001, "\x08\x06\x30\x05\x41TEXT ID ERROR!\x05\x40"), # Fallback text
...
dungeon_list = {
    #                      dungeon name                      gender
    'Deku Tree':          ("the \x05\x42Deku Tree",          "no_gender"),
    'Dodongos Cavern':    ("\x05\x41Dodongo\'s Cavern",      "no_gender"),
    'Jabu Jabus Belly':   ("\x05\x43Jabu Jabu\'s Belly",     "no_gender"),
    'Forest Temple':      ("the \x05\x42Forest Temple",      "no_gender"),
    'Fire Temple':        ("the \x05\x41Fire Temple",        "no_gender"),
    'Water Temple':       ("the \x05\x43Water Temple",       "no_gender"),
    'Spirit Temple':      ("the \x05\x46Spirit Temple",      "no_gender"),
    'Shadow Temple':      ("the \x05\x45Shadow Temple",      "no_gender"),
    'Bottom of the Well': ("the \x05\x45Bottom of the Well", "no_gender"),
    'Ice Cavern':         ("the \x05\x44Ice Cavern",         "no_gender"),
}

additional_dungeon_list = {
    'Ganons Castle Tower':  None,
    'GTG':                  ("the \x05\x46Gerudo Training\x01Ground\x05\x40", "no_gender"),
    'Hideout':              ("the \x05\x46Thieves' Hideout\x05\x40", "no_gender"),
    'Ganons castle':        ("\x05\x41Ganon's Castle\x05\x40", "no_gender"),
    'Tower Collapse':       None,
    'Castle Collapse':      None,
    'Treasure Box Shop':    ("the \x05\x44Treasure Box Shop\x05\x40", "no_gender")
}

dungeon_names = [(name + color_white, gender) if key not in ['Deku Tree', 'Dodongos Cavern', 'Jabu Jabus Belly', 'Ice Cavern'] else None for key, (name, gender) in dungeon_list.items()] + list(additional_dungeon_list.values())
...
key_rings_with_bk_dungeon_names = [(name + color_white, gender) for key, (name, gender) in dungeon_list.items() if key in ['Forest Temple','Fire Temple','Water Temple','Spirit Temple','Shadow Temple']]
...
BOSS_GOAL_TABLE = {
    'Queen Gohma':                                              ("path to the #Spider#", "path to #Queen Gohma#"),
    'King Dodongo':                                             ("path to the #Dinosaur#", "path to #King Dodongo#"),
    'Barinade':                                                 ("path to the #Tentacle#", "path to #Barinade#"),
    'Phantom Ganon':                                            ("path to the #Puppet#", "path to #Phantom Ganon#"),
    'Volvagia':                                                 ("path to the #Dragon#", "path to #Volvagia#"),
    'Morpha':                                                   ("path to the #Amoeba#", "path to #Morpha#"),
    'Bongo Bongo':                                              ("path to the #Hands#", "path to #Bongo Bongo#"),
    'Twinrova':                                                 ("path to the #Witches#", "path to #Twinrova#"),
    'ToT Reward from Rauru':                                    ("path of #time#", "path of #time#"),
}
