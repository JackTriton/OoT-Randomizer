...
MISC_MESSAGES: list[tuple[int, tuple[str | bytearray, int]]] = [
    ...
    (0x507B, ("\x08I tell you, I saw him!\x04\x08I saw the ghostly figure of Damp\x96\x01the gravekeeper sinking into\x01his grave. It looked like he was\x01holding some kind of \x05\x41treasure\x05\x40!\x02", 0x00)),
...
PATCH_TEXTS: dict[str:str] = {
    ...
    "map":                  "\x13\x76\x08You found the \x05\x41Dungeon Map\x05\x40\x01for {dungeon_name}\x05\x40!\x01It\'s {dungeon_state}!\x09",
...
SHOP_TEXTS = {
    ...
    "dungeon_desc_multi": '\x08\x05\x41{base_name}  {price} Rupees\x01({extra_name})\x01\x05\x42Player {player_id}\x05\x40\x01Special deal! ONE LEFT!\x09\x0A\x02',
    "dungeon_desc": '\x08\x05\x41{base_name}  {price} Rupees\x01({extra_name})\x01\x05\x40Special deal! ONE LEFT!\x01Get it while it lasts!\x09\x0A\x02',
    "dungeon_purc": '\x08{base_name}  {price} Rupees\x09\x01({extra_name})\x01\x1B\x05\x42Buy\x01Don\'t buy\x05\x40\x02',
...
hintTable = {
    'Kokiri Emerald':                                           (["a tree's farewell", "the Spiritual Stone of the Forest"], "the Kokiri Emerald", 'o'),
    'Goron Ruby':                                               (["the Gorons' hidden treasure", "the Spiritual Stone of Fire"], "the Goron Ruby", 'o'),
    'Zora Sapphire':                                            (["an engagement ring", "the Spiritual Stone of Water"], "the Zora Sapphire", 'o'),
    'Light Medallion':                                          (["a sagely power frozen in time", "an old man's sagely power", "a yellow disc"], "the Light Medallion", 'o'),
    'Forest Medallion':                                         (["a sagely power given by a childhood friend", "a Kokiri's sagely power", "a green disc"], "the Forest Medallion", 'o'),
    'Fire Medallion':                                           (["a sagely power forged in lava", "a Goron's sagely power", "a red disc"], "the Fire Medallion", 'o'),
    'Water Medallion':                                          (["a sagely power given by your fiancée", "a Zora's sagely power", "a blue disc"], "the Water Medallion", 'o'),
    'Shadow Medallion':                                         (["a sagely power forged in blood", "a Sheikah's sagely power", "a purple disc"], "the Shadow Medallion", 'o'),
    'Spirit Medallion':                                         (["a sagely power tainted by mind control", "a Gerudo's sagely power", "an orange disc"], "the Spirit Medallion", 'o'),
    'Triforce Piece':                                           (["a triumph fork", "cheese", "a gold fragment"], "a Piece of the Triforce", 'o'),
    'Magic Meter':                                              (["mystic training", "pixie dust", "a green rectangle"], "a Magic Meter", 'o'),
    'Double Defense':                                           (["a white outline", "damage decrease", "strengthened love"], "Double Defense", 'o'),
    'Slingshot':                                                (["a seed shooter", "a rubberband", "a child's catapult"], "a Slingshot", 'o'),
    'Boomerang':                                                (["a banana", "a stun stick"], "the Boomerang", 'o'),
    'Bow':                                                      (["an archery enabler", "a danger dart launcher"], "a Bow", 'o'),
    'Bomb Bag':                                                 (["an explosive container", "a blast bag"], "a Bomb Bag", 'o'),
    'Progressive Hookshot':                                     (["Dampé's keepsake", "the Grapple Beam", "the BOING! chain"], "a Hookshot", 'o'),
    'Progressive Strength Upgrade':                             (["power gloves", "metal mittens", "the heavy lifty"], "a Strength Upgrade", 'o'),
    'Progressive Scale':                                        (["a deeper dive", "a piece of Zora"], "a Zora Scale", 'o'),
    'Megaton Hammer':                                           (["the dragon smasher", "the metal mallet", "the heavy hitter"], "the Megaton Hammer", 'o'),
    'Iron Boots':                                               (["sink shoes", "clank cleats"], "the Iron Boots", 'o'),
    'Hover Boots':                                              (["butter boots", "sacred slippers", "spacewalkers"], "the Hover Boots", 'o'),
    'Kokiri Sword':                                             (["a butter knife", "a starter slasher", "a switchblade"], "the Kokiri Sword", 'o'),
    'Giants Knife':                                             (["a fragile blade", "a breakable cleaver"], "the Giant's Knife", 'o'),
    'Biggoron Sword':                                           (["the biggest blade", "a colossal cleaver"], "the Biggoron Sword", 'o'),
    'Master Sword':                                             (["evil's bane"], "the Master Sword", 'o'),
    'Deku Shield':                                              (["a wooden ward", "a burnable barrier"], "a Deku Shield", 'o'),
    'Hylian Shield':                                            (["a steel safeguard", "Like Like's metal meal"], "a Hylian Shield", 'o'),
    'Mirror Shield':                                            (["the reflective rampart", "Medusa's weakness", "a silvered surface"], "the Mirror Shield", 'o'),
    'Farores Wind':                                             (["teleportation", "a relocation rune", "a green ball", "a green gust"], "Farore's Wind", 'o'),
    'Nayrus Love':                                              (["a safe space", "an impregnable aura", "a blue barrier", "a blue crystal"], "Nayru's Love", 'o'),
    'Dins Fire':                                                (["an inferno", "a heat wave", "a red ball"], "Din's Fire", 'o'),
    'Fire Arrows':                                              (["the furnace firearm", "the burning bolts", "a magma missile"], "the Fire Arrows", 'o'),
    'Ice Arrows':                                               (["the refrigerator rocket", "the frostbite bolts", "an iceberg maker"], "the Ice Arrows", 'o'),
    'Blue Fire Arrows':                                         (["the icy hot rocket", "the blue bolts", "an iceberg destroyer"], "the Blue Fire Arrows", 'o'),
    'Light Arrows':                                             (["the shining shot", "the luminous launcher", "Ganondorf's bane", "the lighting bolts"], "the Light Arrows", 'o'),
    'Lens of Truth':                                            (["a lie detector", "a ghost tracker", "true sight", "a detective's tool"], "the Lens of Truth", 'o'),
    'Ocarina':                                                  (["a flute", "a music maker"], "an Ocarina", 'o'),
    'Goron Tunic':                                              (["ruby robes", "fireproof fabric", "cooking clothes"], "a Goron Tunic", 'o'),
    'Zora Tunic':                                               (["a sapphire suit", "scuba gear", "a swimsuit"], "a Zora Tunic", 'o'),
    'Epona':                                                    (["a horse", "a four legged friend"], "Epona", 'o'),
    'Zeldas Lullaby':                                           (["a song of royal slumber", "a triforce tune"], "Zelda's Lullaby", 'o'),
    'Eponas Song':                                              (["an equestrian etude", "Malon's melody", "a ranch song"], "Epona's Song", 'o'),
    'Sarias Song':                                              (["a song of dancing Gorons", "Saria's phone number"], "Saria's Song", 'o'),
    'Suns Song':                                                (["Sunny Day", "the ReDead's bane", "the Gibdo's bane"], "the Sun's Song", 'o'),
    'Song of Time':                                             (["a song 7 years long", "the tune of ages"], "the Song of Time", 'o'),
    'Song of Storms':                                           (["Rain Dance", "a thunderstorm tune", "windmill acceleration"], "the Song of Storms", 'o'),
    'Minuet of Forest':                                         (["the song of tall trees", "an arboreal anthem", "a green spark trail"], "the Minuet of Forest", 'o'),
    'Bolero of Fire':                                           (["a song of lethal lava", "a red spark trail", "a volcanic verse"], "the Bolero of Fire", 'o'),
    'Serenade of Water':                                        (["a song of a damp ditch", "a blue spark trail", "the lake's lyric"], "the Serenade of Water", 'o'),
    'Requiem of Spirit':                                        (["a song of sandy statues", "an orange spark trail", "the desert ditty"], "the Requiem of Spirit", 'o'),
    'Nocturne of Shadow':                                       (["a song of spooky spirits", "a graveyard boogie", "a haunted hymn", "a purple spark trail"], "the Nocturne of Shadow", 'o'),
    'Prelude of Light':                                         (["a luminous prologue melody", "a yellow spark trail", "the temple traveler"], "the Prelude of Light", 'o'),
    'Bottle':                                                   (["a glass container", "an empty jar", "encased air"], "a Bottle", 'o'),
    'Rutos Letter':                                             (["a call for help", "the note that Mweeps", "an SOS call", "a fishy stationery"], "Ruto's Letter", 'o'),
    'Bottle with Milk':                                         (["cow juice", "a white liquid", "a baby's breakfast"], "a Milk Bottle", 'o'),
    'Bottle with Red Potion':                                   (["a vitality vial", "a red liquid"], "a Red Potion Bottle", 'o'),
    'Bottle with Green Potion':                                 (["a magic mixture", "a green liquid"], "a Green Potion Bottle", 'o'),
    'Bottle with Blue Potion':                                  (["an ailment antidote", "a blue liquid"], "a Blue Potion Bottle", 'o'),
    'Bottle with Fairy':                                        (["an imprisoned fairy", "an extra life"], "a Fairy Bottle", 'o'),
    'Bottle with Fish':                                         (["an aquarium", "a deity's snack"], "a Fish Bottle", 'o'),
    'Bottle with Blue Fire':                                    (["a conflagration canteen", "an icemelt jar"], "a Blue Fire Bottle", 'o'),
    'Bottle with Bugs':                                         (["an insectarium", "Skulltula finders"], "a Bug Bottle", 'o'),
    'Bottle with Poe':                                          (["a spooky ghost", "a face in the jar"], "a Poe Bottle", 'o'),
    'Bottle with Big Poe':                                      (["the spookiest ghost", "a sidequest spirit"], "a Big Poe Bottle", 'o'),
    'Stone of Agony':                                           (["the shake stone", "the Rumble Pak (TM)"], "the Stone of Agony", 'o'),
    'Gerudo Membership Card':                                   (["a girl club membership", "a desert tribe's pass"], "the Gerudo Card", 'o'),
    'Progressive Wallet':                                       (["a mo' money holder", "a gem purse", "a portable bank"], "a Wallet", 'o'),
    'Deku Stick Capacity':                                      (["a lumber rack", "more flammable twigs"], "Deku Stick Capacity", 'o'),
    'Deku Nut Capacity':                                        (["more nuts", "flashbang storage"], "Deku Nut Capacity", 'o'),
    'Heart Container':                                          (["a lot of love", "a Valentine's gift", "a boss's organ"], "a Heart Container", 'o'),
    'Piece of Heart':                                           (["a little love", "a broken heart"], "a Piece of Heart", 'o'),
    'Piece of Heart (Treasure Chest Game)':                     ("a victory valentine", "a Piece of Heart", 'o'),
    'Recovery Heart':                                           (["a free heal", "a hearty meal", "a Band-Aid"], "a Recovery Heart", 'o'),
    'Rupee (Treasure Chest Game) (1)':                          ("the green gem of grief", 'a Green Rupee', 'o'),
    'Rupees (Treasure Chest Game) (5)':                         ("the blue gem of blunder", 'a Blue Rupee', 'o'),
    'Rupees (Treasure Chest Game) (20)':                        ("the red gem of regret", 'a Red Rupee', 'o'),
    'Rupees (Treasure Chest Game) (50)':                        ("the purple gem of punishment", 'a Purple Rupee', 'o'),
    'Deku Stick (1)':                                           ("a breakable branch", 'a Deku Stick', 'o'),
    'Rupee (1)':                                                (["a unique coin", "a penny", "a green gem"], "a Green Rupee", 'o'),
    'Rupees (5)':                                               (["a common coin", "a blue gem"], "a Blue Rupee", 'o'),
    'Rupees (20)':                                              (["couch cash", "a red gem"], "a Red Rupee", 'o'),
    'Rupees (50)':                                              (["big bucks", "a purple gem", "wealth"], "a Purple Rupee", 'o'),
    'Rupees (200)':                                             (["a juicy jackpot", "a yellow gem", "a giant gem", "great wealth"], "a Huge Rupee", 'o'),
    'Weird Egg':                                                (["a chicken dilemma"], "the Weird Egg", 'o'),
    'Chicken':                                                  (["a chicken dilemma"], "the Chicken",'o'),
    'Zeldas Letter':                                            (["an autograph", "royal stationery", "royal snail mail"], "Zelda's Letter", 'o'),
    'Keaton Mask':                                              (["the famous façade"], "the Keaton Mask", 'o'),
    'Skull Mask':                                               (["the fleshless façade"], "the Skull Mask", 'o'),
    'Spooky Mask':                                              (["the frightening façade"], "the Spooky Mask", 'o'),
    'Bunny Hood':                                               (["the fast façade"], "the Bunny Hood", 'o'),
    'Goron Mask':                                               (["the fraternal façade"], "the Goron Mask", 'o'),
    'Zora Mask':                                                (["the fishy façade"], "the Zora Mask", 'o'),
    'Gerudo Mask':                                              (["the feminine façade"], "the Gerudo Mask", 'o'),
    'Mask of Truth':                                            (["the factual façade"], "the Mask of Truth", 'o'),
    'Pocket Egg':                                               (["a Cucco container", "a Cucco, eventually", "a fowl youth"], "the Pocket Egg", 'o'),
    'Pocket Cucco':                                             (["a little clucker"], "the Pocket Cucco", 'o'),
    'Cojiro':                                                   (["a cerulean capon"], "Cojiro", 'o'),
    'Odd Mushroom':                                             (["a powder ingredient"], "an Odd Mushroom", 'o'),
    'Odd Potion':                                               (["Granny's goodies"], "an Odd Potion", 'o'),
    'Poachers Saw':                                             (["a tree killer"], "the Poacher's Saw", 'o'),
    'Broken Sword':                                             (["a shattered slicer"], "the Broken Sword", 'o'),
    'Prescription':                                             (["a pill pamphlet", "a doctor's note"], "the Prescription", 'o'),
    'Eyeball Frog':                                             (["a perceiving polliwog"], "the Eyeball Frog", 'o'),
    'Eyedrops':                                                 (["a vision vial"], "the Eyedrops", 'o'),
    'Claim Check':                                              (["a three day wait"], "the Claim Check", 'o'),
    'Map':                                                      (["a dungeon atlas", "blueprints"], "a Map", 'o'),
    'Map (Deku Tree)':                                          (["an atlas of an ancient tree", "blueprints of an ancient tree"], "a Map of the Deku Tree", 'o'),
    'Map (Dodongos Cavern)':                                    (["an atlas of an immense cavern", "blueprints of an immense cavern"], "a Map of Dodongo's Cavern", 'o'),
    'Map (Jabu Jabus Belly)':                                   (["an atlas of the belly of a deity", "blueprints of the belly of a deity"], "a Map of Jabu Jabu's Belly", 'o'),
    'Map (Forest Temple)':                                      (["an atlas of a deep forest", "blueprints of a deep forest"], "a Map of the Forest Temple", 'o'),
    'Map (Fire Temple)':                                        (["an atlas of a high mountain", "blueprints of a high mountain"], "a Map of the Fire Temple", 'o'),
    'Map (Water Temple)':                                       (["an atlas of a vast lake", "blueprints of a vast lake"], "a Map of the Water Temple", 'o'),
    'Map (Shadow Temple)':                                      (["an atlas of the house of the dead", "blueprints of the house of the dead"], "a Map of the Shadow Temple", 'o'),
    'Map (Spirit Temple)':                                      (["an atlas of the goddess of the sand", "blueprints of the goddess of the sand"], "a Map of the Spirit Temple", 'o'),
    'Map (Bottom of the Well)':                                 (["an atlas of a shadow's prison", "blueprints of a shadow's prison"], "a Map of the Bottom of the Well", 'o'),
    'Map (Ice Cavern)':                                         (["an atlas of a frozen maze", "blueprints of a frozen maze"], "a Map of the Ice Cavern", 'o'),
    'Compass':                                                  (["a treasure tracker", "a magnetic needle"], "a Compass", 'o'),
    'Compass (Deku Tree)':                                      (["a treasure tracker for an ancient tree", "a magnetic needle for an ancient tree"], "a Deku Tree Compass", 'o'),
    'Compass (Dodongos Cavern)':                                (["a treasure tracker for an immense cavern", "a magnetic needle for an immense cavern"], "a Dodongo's Cavern Compass", 'o'),
    'Compass (Jabu Jabus Belly)':                               (["a treasure tracker for the belly of a deity", "a magnetic needle for the belly of a deity"], "a Jabu Jabu's Belly Compass", 'o'),
    'Compass (Forest Temple)':                                  (["a treasure tracker for a deep forest", "a magnetic needle for a deep forest"], "a Forest Temple Compass", 'o'),
    'Compass (Fire Temple)':                                    (["a treasure tracker for a high mountain", "a magnetic needle for a high mountain"], "a Fire Temple Compass", 'o'),
    'Compass (Water Temple)':                                   (["a treasure tracker for a vast lake", "a magnetic needle for a vast lake"], "a Water Temple Compass", 'o'),
    'Compass (Shadow Temple)':                                  (["a treasure tracker for the house of the dead", "a magnetic needle for the house of the dead"], "a Shadow Temple Compass", 'o'),
    'Compass (Spirit Temple)':                                  (["a treasure tracker for a goddess of the sand", "a magnetic needle for a goddess of the sand"], "a Spirit Temple Compass", 'o'),
    'Compass (Bottom of the Well)':                             (["a treasure tracker for a shadow's prison", "a magnetic needle for a shadow's prison"], "a Bottom of the Well Compass", 'o'),
    'Compass (Ice Cavern)':                                     (["a treasure tracker for a frozen maze", "a magnetic needle for a frozen maze"], "an Ice Cavern Compass", 'o'),
    'BossKey':                                                  (["a master of unlocking", "a dungeon's master pass"], "a Boss Key", 'o'),
    'GanonBossKey':                                             (["a master of unlocking", "a dungeon's master pass"], "a Boss Key", 'o'),
    'SmallKey':                                                 (["a tool for unlocking", "a dungeon pass", "a lock remover", "a lockpick"], "a Small Key", 'o'),
    'HideoutSmallKey':                                          (["a get out of jail free card"], "a Jail Key", 'o'),
    'TCGSmallKey':                                              (["a key to becoming a winner"], "a Game Key", 'o'),
    'SmallKeyRing':                                             (["a toolbox for unlocking", "a dungeon season pass", "a jingling ring", "a skeleton key"], "a Small Key Ring", 'o'),
    'HideoutSmallKeyRing':                                      (["a deck of get out of jail free cards"], "a Jail Key Ring", 'o'),
    'TCGSmallKeyRing':                                          (["the keys to becoming a winner"], "a Game Key Ring", 'o'),
    'SilverRupee':                                              (["an entry fee", "a priced artifact"], "a Silver Rupee", 'o'),
    'Boss Key (Forest Temple)':                                 (["a master of unlocking for a deep forest", "a master pass for a deep forest"], "the Forest Temple Boss Key", 'o'),
    'Boss Key (Fire Temple)':                                   (["a master of unlocking for a high mountain", "a master pass for a high mountain"], "the Fire Temple Boss Key", 'o'),
    'Boss Key (Water Temple)':                                  (["a master of unlocking for under a vast lake", "a master pass for under a vast lake"], "the Water Temple Boss Key", 'o'),
    'Boss Key (Shadow Temple)':                                 (["a master of unlocking for the house of the dead", "a master pass for the house of the dead"], "the Shadow Temple Boss Key", 'o'),
    'Boss Key (Spirit Temple)':                                 (["a master of unlocking for a goddess of the sand", "a master pass for a goddess of the sand"], "the Spirit Temple Boss Key", 'o'),
    'Boss Key (Ganons Castle)':                                 (["a master of unlocking for a conquered citadel", "a floating dungeon's master pass"], "Ganon's Castle Boss Key", 'o'),
    'Small Key (Forest Temple)':                                (["a tool for unlocking a deep forest", "a dungeon pass for a deep forest", "a lock remover for a deep forest", "a lockpick for a deep forest"], "a Forest Temple Small Key", 'o'),
    'Small Key (Fire Temple)':                                  (["a tool for unlocking a high mountain", "a dungeon pass for a high mountain", "a lock remover for a high mountain", "a lockpick for a high mountain"], "a Fire Temple Small Key", 'o'),
    'Small Key (Water Temple)':                                 (["a tool for unlocking a vast lake", "a dungeon pass for under a vast lake", "a lock remover for under a vast lake", "a lockpick for under a vast lake"], "a Water Temple Small Key", 'o'),
    'Small Key (Shadow Temple)':                                (["a tool for unlocking the house of the dead", "a dungeon pass for the house of the dead", "a lock remover for the house of the dead", "a lockpick for the house of the dead"], "a Shadow Temple Small Key", 'o'),
    'Small Key (Spirit Temple)':                                (["a tool for unlocking a goddess of the sand", "a dungeon pass for a goddess of the sand", "a lock remover for a goddess of the sand", "a lockpick for a goddess of the sand"], "a Spirit Temple Small Key", 'o'),
    'Small Key (Bottom of the Well)':                           (["a tool for unlocking a shadow's prison", "a dungeon pass for a shadow's prison", "a lock remover for a shadow's prison", "a lockpick for a shadow's prison"], "a Bottom of the Well Small Key", 'o'),
    'Small Key (Gerudo Training Ground)':                       (["a tool for unlocking the test of thieves", "a dungeon pass for the test of thieves", "a lock remover for the test of thieves", "a lockpick for the test of thieves"], "a Gerudo Training Ground Small Key", 'o'),
    'Small Key (Ganons Castle)':                                (["a tool for unlocking a conquered citadel", "a dungeon pass for a conquered citadel", "a lock remover for a conquered citadel", "a lockpick for a conquered citadel"], "a Ganon's Castle Small Key", 'o'),
    'Small Key (Thieves Hideout)':                              (["a get out of jail free card"], "a Jail Key", 'o'),
    'Small Key (Treasure Chest Game)':                          (["a key to becoming a winner"], "a Game Key", 'o'),
    'Small Key Ring (Forest Temple)':                           (["a toolbox for unlocking a deep forest", "a dungeon season pass for a deep forest", "a jingling ring for a deep forest", "a skeleton key for a deep forest"], "a Forest Temple Small Key Ring", 'o'),
    'Small Key Ring (Fire Temple)':                             (["a toolbox for unlocking a high mountain", "a dungeon season pass for a high mountain", "a jingling ring for a high mountain", "a skeleton key for a high mountain"], "a Fire Temple Small Key Ring", 'o'),
    'Small Key Ring (Water Temple)':                            (["a toolbox for unlocking a vast lake", "a dungeon season pass for under a vast lake", "a jingling ring for under a vast lake", "a skeleton key for under a vast lake"], "a Water Temple Small Key Ring", 'o'),
    'Small Key Ring (Shadow Temple)':                           (["a toolbox for unlocking the house of the dead", "a dungeon season pass for the house of the dead", "a jingling ring for the house of the dead", "a skeleton key for the house of the dead"], "a Shadow Temple Small Key Ring", 'o'),
    'Small Key Ring (Spirit Temple)':                           (["a toolbox for unlocking a goddess of the sand", "a dungeon season pass for a goddess of the sand", "a jingling ring for a goddess of the sand", "a skeleton key for a goddess of the sand"], "a Spirit Temple Small Key Ring", 'o'),
    'Small Key Ring (Bottom of the Well)':                      (["a toolbox for unlocking a shadow's prison", "a dungeon season pass for a shadow's prison", "a jingling ring for a shadow's prison", "a skeleton key for a shadow's prison"], "a Bottom of the Well Small Key Ring", 'o'),
    'Small Key Ring (Gerudo Training Ground)':                  (["a toolbox for unlocking the test of thieves", "a dungeon season pass for the test of thieves", "a jingling ring for the test of thieves", "a skeleton key for the test of thieves"], "a Gerudo Training Ground Small Key Ring", 'o'),
    'Small Key Ring (Ganons Castle)':                           (["a toolbox for unlocking a conquered citadel", "a dungeon season pass for a conquered citadel", "a jingling ring for a conquered citadel", "a skeleton key for a conquered citadel"], "a Ganon's Castle Small Key Ring", 'o'),
    'Small Key Ring (Thieves Hideout)':                         (["a deck of get out of jail free cards"], "a Jail Key Ring", 'o'),
    'Small Key Ring (Treasure Chest Game)':                     (["the keys to becoming a winner"], "a Game Key Ring", 'o'),
    'Silver Rupee (Dodongos Cavern Staircase)':                 (["an entry fee for an immense cavern", "a priced artifact from an immense cavern"], "a Silver Rupee for Dodongo's Cavern", 'o'),
    'Silver Rupee (Ice Cavern Spinning Scythe)':                (["an entry fee for a frozen maze", "a priced artifact from a frozen maze"], "a Silver Rupee for the Ice Cavern", 'o'),
    'Silver Rupee (Ice Cavern Push Block)':                     (["an entry fee for a frozen maze", "a priced artifact from a frozen maze"], "a Silver Rupee for the Ice Cavern", 'o'),
    'Silver Rupee (Bottom of the Well Basement)':               (["an entry fee for a shadow's prison", "a priced artifact from a shadow's prison"], "a Silver Rupee for the Bottom of the Well", 'o'),
    'Silver Rupee (Shadow Temple Scythe Shortcut)':             (["an entry fee for the house of the dead", "a priced artifact from the house of the dead"], "a Silver Rupee for the Shadow Temple", 'o'),
    'Silver Rupee (Shadow Temple Invisible Blades)':            (["an entry fee for the house of the dead", "a priced artifact from the house of the dead"], "a Silver Rupee for the Shadow Temple", 'o'),
    'Silver Rupee (Shadow Temple Huge Pit)':                    (["an entry fee for the house of the dead", "a priced artifact from the house of the dead"], "a Silver Rupee for the Shadow Temple", 'o'),
    'Silver Rupee (Shadow Temple Invisible Spikes)':            (["an entry fee for the house of the dead", "a priced artifact from the house of the dead"], "a Silver Rupee for the Shadow Temple", 'o'),
    'Silver Rupee (Gerudo Training Ground Slopes)':             (["an entry fee for the test of thieves", "a priced artifact from the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'o'),
    'Silver Rupee (Gerudo Training Ground Lava)':               (["an entry fee for the test of thieves", "a priced artifact from the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'o'),
    'Silver Rupee (Gerudo Training Ground Water)':              (["an entry fee for the test of thieves", "a priced artifact from the test of thieves"], "a Silver Rupee for the Gerudo Training Ground", 'o'),
    'Silver Rupee (Spirit Temple Child Early Torches)':         (["an entry fee for a goddess of the sand", "a priced artifact from a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'o'),
    'Silver Rupee (Spirit Temple Adult Boulders)':              (["an entry fee for a goddess of the sand", "a priced artifact from a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'o'),
    'Silver Rupee (Spirit Temple Lobby and Lower Adult)':       (["an entry fee for a goddess of the sand", "a priced artifact from a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'o'),
    'Silver Rupee (Spirit Temple Sun Block)':                   (["an entry fee for a goddess of the sand", "a priced artifact from a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'o'),
    'Silver Rupee (Spirit Temple Adult Climb)':                 (["an entry fee for a goddess of the sand", "a priced artifact from a goddess of the sand"], "a Silver Rupee for the Spirit Temple", 'o'),
    'Silver Rupee (Ganons Castle Spirit Trial)':                (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee (Ganons Castle Light Trial)':                 (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee (Ganons Castle Fire Trial)':                  (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee (Ganons Castle Shadow Trial)':                (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee (Ganons Castle Water Trial)':                 (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee (Ganons Castle Forest Trial)':                (["an entry fee for a conquered citadel", "a priced artifact from a conquered citadel"], "a Silver Rupee for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Dodongos Cavern Staircase)':           (["a silver lining for an immense cavern", "a stash of silver shekels for an immense cavern"], "a Pouch of Silver Rupees for Dodongo's Cavern", 'o'),
    'Silver Rupee Pouch (Ice Cavern Spinning Scythe)':          (["a silver lining for a frozen maze", "a stash of silver shekels for a frozen maze"], "a Pouch of Silver Rupees for the Ice Cavern", 'o'),
    'Silver Rupee Pouch (Ice Cavern Push Block)':               (["a silver lining for a frozen maze", "a stash of silver shekels for a frozen maze"], "a Pouch of Silver Rupees for the Ice Cavern", 'o'),
    'Silver Rupee Pouch (Bottom of the Well Basement)':         (["a silver lining for a shadow's prison", "a stash of silver shekels for a shadow's prison"], "a Pouch of Silver Rupees for the Bottom of the Well", 'o'),
    'Silver Rupee Pouch (Shadow Temple Scythe Shortcut)':       (["a silver lining for the house of the dead", "a stash of silver shekels for the house of the dead"], "a Pouch of Silver Rupees for the Shadow Temple", 'o'),
    'Silver Rupee Pouch (Shadow Temple Invisible Blades)':      (["a silver lining for the house of the dead", "a stash of silver shekels for the house of the dead"], "a Pouch of Silver Rupees for the Shadow Temple", 'o'),
    'Silver Rupee Pouch (Shadow Temple Huge Pit)':              (["a silver lining for the house of the dead", "a stash of silver shekels for the house of the dead"], "a Pouch of Silver Rupees for the Shadow Temple", 'o'),
    'Silver Rupee Pouch (Shadow Temple Invisible Spikes)':      (["a silver lining for the house of the dead", "a stash of silver shekels for the house of the dead"], "a Pouch of Silver Rupees for the Shadow Temple", 'o'),
    'Silver Rupee Pouch (Gerudo Training Ground Slopes)':       (["a silver lining for the test of thieves", "a stash of silver shekels for the test of thieves"], "a Pouch of Silver Rupees for the Gerudo Training Ground", 'o'),
    'Silver Rupee Pouch (Gerudo Training Ground Lava)':         (["a silver lining for the test of thieves", "a stash of silver shekels for the test of thieves"], "a Pouch of Silver Rupees for the Gerudo Training Ground", 'o'),
    'Silver Rupee Pouch (Gerudo Training Ground Water)':        (["a silver lining for the test of thieves", "a stash of silver shekels for the test of thieves"], "a Pouch of Silver Rupees for the Gerudo Training Ground", 'o'),
    'Silver Rupee Pouch (Spirit Temple Child Early Torches)':   (["a silver lining for a goddess of the sand", "a stash of silver shekels for a goddess of the sand"], "a Pouch of Silver Rupees for the Spirit Temple", 'o'),
    'Silver Rupee Pouch (Spirit Temple Adult Boulders)':        (["a silver lining for a goddess of the sand", "a stash of silver shekels for a goddess of the sand"], "a Pouch of Silver Rupees for the Spirit Temple", 'o'),
    'Silver Rupee Pouch (Spirit Temple Lobby and Lower Adult)': (["a silver lining for a goddess of the sand", "a stash of silver shekels for a goddess of the sand"], "a Pouch of Silver Rupees for the Spirit Temple", 'o'),
    'Silver Rupee Pouch (Spirit Temple Sun Block)':             (["a silver lining for a goddess of the sand", "a stash of silver shekels for a goddess of the sand"], "a Pouch of Silver Rupees for the Spirit Temple", 'o'),
    'Silver Rupee Pouch (Spirit Temple Adult Climb)':           (["a silver lining for a goddess of the sand", "a stash of silver shekels for a goddess of the sand"], "a Pouch of Silver Rupees for the Spirit Temple", 'o'),
    'Silver Rupee Pouch (Ganons Castle Spirit Trial)':          (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Ganons Castle Light Trial)':           (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Ganons Castle Fire Trial)':            (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Ganons Castle Shadow Trial)':          (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Ganons Castle Water Trial)':           (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'Silver Rupee Pouch (Ganons Castle Forest Trial)':          (["a silver lining for a conquered citadel", "a stash of silver shekels for a conquered citadel"], "a Pouch of Silver Rupees for Ganon's Castle", 'o'),
    'KeyError':                                                 (["something mysterious", "an unknown treasure"], "An Error (Please Report This)", 'o'),
    'Arrows (5)':                                               (["a few danger darts", "a few sharp shafts"], "Arrows (5 pieces)", 'o'),
    'Arrows (10)':                                              (["some danger darts", "some sharp shafts"], "Arrows (10 pieces)", 'o'),
    'Arrows (30)':                                              (["plenty of danger darts", "plenty of sharp shafts"], "Arrows (30 pieces)", 'o'),
    'Bombs (5)':                                                (["a few explosives", "a few blast balls"], "Bombs (5 pieces)", 'o'),
    'Bombs (10)':                                               (["some explosives", "some blast balls"], "Bombs (10 pieces)", 'o'),
    'Bombs (20)':                                               (["lots-o-explosives", "plenty of blast balls"], "Bombs (20 pieces)", 'o'),
    'Ice Trap':                                                 (["a gift from Ganon", "a chilling discovery", "frosty fun"], "an Ice Trap", 'o'),
    'Magic Bean':                                               (["a wizardly legume"], "a Magic Bean", 'o'),
    'Buy Magic Bean':                                           (["a wizardly legume"], "a Magic Bean", 'o'),
    'Magic Bean Pack':                                          (["wizardly legumes"], "Magic Beans", 'o'),
    'Bombchus':                                                 (["mice bombs", "proximity mice", "wall crawlers", "trail blazers"], "Bombchus", 'o'),
    'Bombchus (5)':                                             (["a few mice bombs", "a few proximity mice", "a few wall crawlers", "a few trail blazers"], "Bombchus (5 pieces)", 'o'),
    'Bombchus (10)':                                            (["some mice bombs", "some proximity mice", "some wall crawlers", "some trail blazers"], "Bombchus (10 pieces)", 'o'),
    'Bombchus (20)':                                            (["plenty of mice bombs", "plenty of proximity mice", "plenty of wall crawlers", "plenty of trail blazers"], "Bombchus (20 pieces)", 'o'),
    'Deku Nuts (5)':                                            (["some nuts", "some flashbangs", "some scrub spit"], "Deku Nuts (5 pieces)", 'o'),
    'Deku Nuts (10)':                                           (["lots-o-nuts", "plenty of flashbangs", "plenty of scrub spit"], "Deku Nuts (10 pieces)", 'o'),
    'Deku Seeds (30)':                                          (["catapult ammo", "lots-o-seeds"], "Deku Seeds (30 pieces)", 'o'),
    'Gold Skulltula Token':                                     (["proof of destruction", "an arachnid chip", "spider remains", "one percent of a curse"], "a Gold Skulltula Token", 'o'),
    'Ocarina A Button':                                         (["a blue note"], "the Ocarina A Button", 'o'),
    'Ocarina C up Button':                                      (["a high note"], "the Ocarina C up Button", 'o'),
    'Ocarina C down Button':                                    (["a low note"], "the Ocarina C down Button", 'o'),
    'Ocarina C left Button':                                    (["a somewhat high note"], "the Ocarina C left Button", 'o'),
    'Ocarina C right Button':                                   (["a middle note"], "the Ocarina C right Button", 'o'),
    'Fairy Drop':                                               (["an annoying companion", "Navi's cousin"], "a Stray Fairy", 'o'),
    'Nothing':                                                  (["emptiness", "loneliness"], "Nothing", 'o'),
    ...
    'Ganons Castle Grounds -> Ganons Castle Lobby':             ("the #rainbow bridge# leads to", None, None),
    'Ganons Castle Main -> Ganons Castle Tower':                ("a #castle barrier# protects the way to", "#Ganon's trials# protect the way to", None),

    'KF Links House':                                           ("Link's House", None, 'o'),
    'Temple of Time':                                           ("the #Temple of Time#", None, 'o'),
    'KF Midos House':                                           ("Mido's house", None, 'o'),
    'KF Sarias House':                                          ("Saria's House", None, 'o'),
    'KF House of Twins':                                        ("the #House of Twins#", None, 'o'),
    'KF Know It All House':                                     ("Know-It-All Brothers' House", None, 'o'),
    'KF Kokiri Shop':                                           ("the #Kokiri Shop#", None, 'o'),
    'LH Lab':                                                   ("the #Lakeside Laboratory#", None, 'o'),
    'LH Fishing Hole':                                          ("the #Fishing Pond#", None, 'o'),
    'GV Carpenter Tent':                                        ("the #Carpenters' tent#", None, 'o'),
    'Market Guard House':                                       ("the #Guard House#", None, 'o'),
    'Market Mask Shop':                                         ("the #Happy Mask Shop#", None, 'o'),
    'Market Bombchu Bowling':                                   ("the #Bombchu Bowling Alley#", None, 'o'),
    'Market Potion Shop':                                       ("the #Market Potion Shop#", None, 'o'),
    'Market Treasure Chest Game':                               ("the #Treasure Box Shop#", None, 'o'),
    'Market Bombchu Shop':                                      ("the #Bombchu Shop#", None, 'o'),
    'Market Man in Green House':                                ("Man in Green's House", None, 'o'),
    'Kak Windmill':                                             ("the #Windmill#", None, 'o'),
    'Kak Carpenter Boss House':                                 ("the #Carpenters' Boss House#", None, 'o'),
    'Kak House of Skulltula':                                   ("the #House of Skulltula#", None, 'o'),
    'Kak Impas House':                                          ("Impa's House", None, 'o'),
    'Kak Impas House Back':                                     ("Impa's cow cage", None, 'o'),
    'Kak Odd Medicine Building':                                ("Granny's Potion Shop", None, 'o'),
    'Graveyard Dampes House':                                   ("Dampé's Hut", None, 'o'),
    'GC Shop':                                                  ("the #Goron Shop#", None, 'o'),
    'ZD Shop':                                                  ("the #Zora Shop#", None, 'o'),
    'LLR Talons House':                                         ("Talon's House", None, 'o'),
    'LLR Stables':                                              ("a #stable#", None, 'o'),
    'LLR Tower':                                                ("the #Lon Lon Tower#", None, 'o'),
    'Market Bazaar':                                            ("the #Market Bazaar#", None, 'o'),
    'Market Shooting Gallery':                                  ("a #Slingshot Shooting Gallery#", None, 'o'),
    'Kak Bazaar':                                               ("the #Kakariko Bazaar#", None, 'o'),
    'Kak Potion Shop Front':                                    ("the #Kakariko Potion Shop#", None, 'o'),
    'Kak Potion Shop Back':                                     ("the #Kakariko Potion Shop#", None, 'o'),
    'Kak Shooting Gallery':                                     ("a #Bow Shooting Gallery#", None, 'o'),
    'Colossus Great Fairy Fountain':                            ("a #Great Fairy Fountain#", None, 'o'),
    'HC Great Fairy Fountain':                                  ("a #Great Fairy Fountain#", None, 'o'),
    'OGC Great Fairy Fountain':                                 ("a #Great Fairy Fountain#", None, 'o'),
    'DMC Great Fairy Fountain':                                 ("a #Great Fairy Fountain#", None, 'o'),
    'DMT Great Fairy Fountain':                                 ("a #Great Fairy Fountain#", None, 'o'),
    'ZF Great Fairy Fountain':                                  ("a #Great Fairy Fountain#", None, 'o'),
    'Graveyard Shield Grave':                                   ("a #grave with a free chest#", None, 'o'),
    'Graveyard Heart Piece Grave':                              ("a chest spawned by #Sun's Song#", None, 'o'),
    'Graveyard Royal Familys Tomb':                             ("the #Royal Family's Tomb#", None, 'o'),
    'Graveyard Dampes Grave':                                   ("Dampé's Grave", None, 'o'),
    'DMT Cow Grotto':                                           ("a solitary #Cow#", None, 'o'),
    'HC Storms Grotto':                                         ("a sandy grotto with #fragile walls#", None, 'o'),
    'HF Tektite Grotto':                                        ("a pool guarded by a #Tektite#", None, 'o'),
    'HF Near Kak Grotto':                                       ("a #Big Skulltula# guarding a Gold one", None, 'o'),
    'HF Cow Grotto':                                            ("a grotto full of #spider webs#", None, 'o'),
    'Kak Redead Grotto':                                        ("#ReDeads# guarding a chest", None, 'o'),
    'SFM Wolfos Grotto':                                        ("#Wolfos# guarding a chest", None, 'o'),
    'GV Octorok Grotto':                                        ("an #Octorok# guarding a rich pool", None, 'o'),
    'Deku Theater':                                             ("the #Lost Woods Stage#", None, 'o'),
    'ZR Open Grotto':                                           ("a #generic grotto#", None, 'o'),
    'DMC Upper Grotto':                                         ("a #generic grotto#", None, 'o'),
    'DMT Storms Grotto':                                        ("a #generic grotto#", None, 'o'),
    'Kak Open Grotto':                                          ("a #generic grotto#", None, 'o'),
    'HF Near Market Grotto':                                    ("a #generic grotto#", None, 'o'),
    'HF Open Grotto':                                           ("a #generic grotto#", None, 'o'),
    'HF Southeast Grotto':                                      ("a #generic grotto#", None, 'o'),
    'KF Storms Grotto':                                         ("a #generic grotto#", None, 'o'),
    'LW Near Shortcuts Grotto':                                 ("a #generic grotto#", None, 'o'),
    'HF Inside Fence Grotto':                                   ("a #lonely Deku Scrub#", None, 'o'),
    'LW Scrubs Grotto':                                         ("#2 Deku Scrubs# including an Upgrade one", None, 'o'),
    'Colossus Grotto':                                          ("2 Deku Scrubs", None, 'o'),
    'ZR Storms Grotto':                                         ("2 Deku Scrubs", None, 'o'),
    'SFM Storms Grotto':                                        ("2 Deku Scrubs", None, 'o'),
    'GV Storms Grotto':                                         ("2 Deku Scrubs", None, 'o'),
    'LH Grotto':                                                ("3 Deku Scrubs", None, 'o'),
    'DMC Hammer Grotto':                                        ("3 Deku Scrubs", None, 'o'),
    'GC Grotto':                                                ("3 Deku Scrubs", None, 'o'),
    'LLR Grotto':                                               ("3 Deku Scrubs", None, 'o'),
    'ZR Fairy Grotto':                                          ("a small #Fairy Fountain#", None, 'o'),
    'HF Fairy Grotto':                                          ("a small #Fairy Fountain#", None, 'o'),
    'SFM Fairy Grotto':                                         ("a small #Fairy Fountain#", None, 'o'),
    'ZD Storms Grotto':                                         ("a small #Fairy Fountain#", None, 'o'),
    'GF Storms Grotto':                                         ("a small #Fairy Fountain#", None, 'o'),
    'Queen Gohma Boss Room':                                    ("the #Parasitic Armored Arachnid#", "#Queen Gohma#", 'o'),
    'King Dodongo Boss Room':                                   ("the #Infernal Dinosaur#", "#King Dodongo#", 'o'),
    'Barinade Boss Room':                                       ("the #Bio-Electric Anemone#", "#Barinade#", 'o'),
    'Phantom Ganon Boss Room':                                  ("the #Evil Spirit from Beyond#", "#Phantom Ganon#", 'o'),
    'Volvagia Boss Room':                                       ("the #Subterranean Lava Dragon#", "#Volvagia#", 'o'),
    'Morpha Boss Room':                                         ("the #Giant Aquatic Amoeba#", "#Morpha#", 'o'),
    'Bongo Bongo Boss Room':                                    ("the #Phantom Shadow Beast#", "#Bongo Bongo#", 'o'),
    'Twinrova Boss Room':                                       ("the #Sorceress Sisters#", "#Twinrova#", 'o'),
    'Ganons Castle Tower':                                      ("#Ganon's Tower#", None, 'o'),
    ...
    'Child Altar Text End':                                     ("\x13\x07Ye who may become a Hero...&Stand with the Ocarina and&play the Song of Time.", None, None),
...
hint_text = {
    ...
    "woh": "{location_text} is on the way of the hero.",
    ...
    "cbf": "#{item_text}# can be found {location_text}.",
    "hero": "{location_text} may be on the hero's path.",
    "important": " Important Check",
    "conjunction": " and ",
    "conjunction_more": ", ",
    ...
    "trial_combine_sheik": "the #{trial} Trials# were dispelled by Sheik.",
    "trial_sheik": "the #{trial} Trial# was dispelled by Sheik.",
    "trial_combine_ganon": "the #{trial} Trials# protect Ganon's Tower.",
...
d = {
    ...
    "KEYSANITY_MESSAGES": KEYSANITY_MESSAGES,
